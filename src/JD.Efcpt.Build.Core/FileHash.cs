...
{
    /// <summary>Computes the XxHash64 hash of a file's contents.</summary>
    ...
    /// <summary>Computes the XxHash64 hash of a byte array.</summary>
    public static string HashBytes(byte[] bytes)
    {
        return XxHash64.HashToUInt64(bytes).ToString("x16");
    }

    /// <summary>Computes the XxHash64 hash of a UTF-8 encoded string.</summary>
